<script setup>
    ...
    <template>
        <div class="bg-dark-navy-500">
            <div class="mx-auto container py-24 sm:px-6 sm:py-32 lg:px-8 text-center">
                <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                    ...
                    <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left m-10 lg:m-0">
                        <h2 class="text-3xl font-semibold tracking-tight text-balance dark:text-dark-navy-100 sm:text-4xl">Boost your productivity. Start using our app today.</h2>
